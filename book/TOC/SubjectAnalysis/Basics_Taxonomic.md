...
```
````
```{table} Title: The effect of host plant on the biological control efficacy of the predatory mite, Phytoseiulus persimilis Athias-Henriot against two-spotted spidermites, Tetranychus vurticae koch on field-grown vegetables.
align: left 
|------------------------------------------------------------------------------------|
